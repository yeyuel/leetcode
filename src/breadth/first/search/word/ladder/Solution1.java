...
public class Solution1
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(new Solution1().ladderLength("hit", "cog", Arrays.asList(wordList1)));
        System.out.println(new Solution1().ladderLength("hit", "cog", Arrays.asList(wordList2)));
    }
}
